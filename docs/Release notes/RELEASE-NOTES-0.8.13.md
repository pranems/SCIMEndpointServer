...
## Upgrade Command
```powershell
iex (irm 'https://raw.githubusercontent.com/pranems/SCIMServer/master/scripts/update-scimserver-direct.ps1'); Update-SCIMServerDirect -Version v0.8.13 -ResourceGroup <rg> -AppName <app> -NoPrompt
```
